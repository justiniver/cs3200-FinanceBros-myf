...
- Access to required secrets or password files
- Clone the repo to your computer. 
- Set up the `.env` file in the `api` folder based on the `.env.template` file.
- Start the docker containers. 

## Disclaimer
This website is owned and operated by FinanceBros (“Company,” “we,”, "I", or “us”). 

The information provided on this platform is for educational and entertainment purposes only and should not be construed as financial advice. We are not licensed financial advisors. Any investment decisions or financial strategies discussed here should be considered with caution and consulted with a qualified financial advisor. Your financial situation is unique, and it is important to seek personalized advice before making any financial decisions.
